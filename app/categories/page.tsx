...
export const metadata: Metadata = {
  ...
  description:
    'Browse all Daily Number Match puzzle categories. Explore Animals, Nature, Cities, Art, and Food levels with beginner-to-expert difficulty.',
  keywords: ['puzzle categories', 'jigsaw categories', 'Daily Number Match categories'],
  alternates: {
