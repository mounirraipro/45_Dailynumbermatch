...
const SITE_URL = 'https://dailynumbermatch.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Daily Number Match',
        url: SITE_URL,
        description: 'Play Daily Number Match free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Daily Number Match online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,
