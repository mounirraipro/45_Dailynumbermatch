...
export const metadata: Metadata = {
    ...
    description: 'Read the Daily Number Match Terms of Service. Understand the rules and guidelines for using our free online game.',
    keywords: ['Daily Number Match terms of service', 'terms and conditions', 'usage agreement'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    Welcome to Daily Number Match. By accessing or using our website and game, you agree to be
                    bound by these Terms of Service. Please read them carefully before using our services.
                </p>

                <h2>1. Acceptance of Terms</h2>
                <p>
                    By accessing Daily Number Match at dailynumbermatch.online, you acknowledge that you have read,
                ...
                <p>
                    Daily Number Match provides a free, browser-based game. Daily Number Match is a free, browser-based game experience.
                    The service includes the game itself, educational content, blog articles, and related resources.
                </p>

                <h2>3. User Eligibility</h2>
                <p>
                    Daily Number Match is available to users of all ages. However, users under 13 years of age
                ...
                <p>
                    All content on Daily Number Match — including but not limited to the game design, code, images,
                    text, graphics, logos, and audio — is the intellectual property of Daily Number Match or its
                ...
                <p>
                    ...
                    Daily Number Match for personal, non-commercial purposes only.
                </p>

                <h2>5. Acceptable Use</h2>
                <p>When using Daily Number Match, you agree NOT to:</p>
                <ul>
                ...
                <p>
                    ...
                    grant Daily Number Match a non-exclusive, royalty-free, perpetual license to use, modify,
                    and incorporate that content into our services.
                </p>

                <h2>7. Advertisements</h2>
                <p>
                    Daily Number Match displays advertisements from third-party ad networks, including Google
                ...
                <p>
                    Daily Number Match is provided &ldquo;as is&rdquo; and &ldquo;as available&rdquo; without warranties of any
                ...
                <p>
                    To the fullest extent permitted by law, Daily Number Match and its operators shall not be
                ...
                <p>
                    We reserve the right to suspend or terminate your access to Daily Number Match at our sole
                ...
                <p>
                    ...
                    <strong>legal@dailynumbermatch.online</strong>.
                </p>
            </div>
        </>
    );
