...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Daily Number Match',
        url: 'https://dailynumbermatch.online/about',
        description: 'Learn about Daily Number Match, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
...
export const metadata: Metadata = {
    title: 'About Us – Daily Number Match',
    description: 'Learn about Daily Number Match, our mission, and the team behind the game.',
    keywords: ['about Daily Number Match', 'game team', 'who made Daily Number Match'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Daily Number Match</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Daily Number Match was born from a simple idea: what if playing Daily Number Match could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Daily Number Match with a clear vision — to create a free, accessible, and
                    ...
                    Daily Number Match has something for you.
                </p>
                ...
                <p>
                    Every level in Daily Number Match is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Daily Number Match offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Daily Number Match better for
                    everyone.
                </p>
            </div>
        </>
