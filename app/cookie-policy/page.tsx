...
export const metadata: Metadata = {
    title: 'Cookie Policy',
    description: 'Learn about the cookies Daily Number Match uses, why we use them, and how to manage your cookie preferences.',
    keywords: ['Daily Number Match cookies', 'cookie policy', 'cookie preferences', 'tracking cookies'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    This Cookie Policy explains what cookies are, how Daily Number Match uses them, and how you can
                ...
                <p>Daily Number Match uses cookies for the following purposes:</p>
                ...
                <p>
                    We currently do not use any tracking or analytics cookies (such as Google Analytics) on Daily Number Match.
                </p>
                ...
                <p>
                    ...
                    or email <strong>privacy@dailynumbermatch.online</strong>.
                </p>
            </div>
        </>
    );
