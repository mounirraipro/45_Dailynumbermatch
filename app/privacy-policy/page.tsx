...
export const metadata: Metadata = {
    ...
    description: 'Read the Daily Number Match Privacy Policy. Learn how we collect, use, and protect your personal data when you use our free online game.',
    keywords: ['Daily Number Match privacy policy', 'data protection', 'cookie policy'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    At Daily Number Match, we are committed to protecting your privacy and ensuring transparency
                ...
                <ul>
                    ...
                    <li>To protect the rights, property, or safety of Daily Number Match, our users, or the public</li>
                </ul>

                <h2>5. Children&apos;s Privacy</h2>
                <p>
                    Daily Number Match is designed to be family-friendly. We do not knowingly collect personal
                ...
                <p>
                    ...
                    <strong>privacy@dailynumbermatch.online</strong>.
                </p>
            </div>
        </>
    );
