...
export const metadata: Metadata = {
    ...
    description: 'Daily Number Match is committed to digital accessibility. Learn about our efforts to make our game available to everyone.',
    keywords: ['Daily Number Match accessibility', 'accessible game', 'web accessibility statement'],
};
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Our commitment to making Daily Number Match accessible to everyone.</p>
                </div>
            </div>

            <div className="page-content">
                <p>
                    Daily Number Match is committed to ensuring digital accessibility for people with disabilities.
                ...
                <p>
                    We recognize that the game component of Daily Number Match presents additional accessibility
                ...
                <h2>Feedback</h2>
                <p>
                    We welcome your feedback on the accessibility of Daily Number Match. If you encounter
                ...
                <ul>
                    ...
                    <li>Email: <strong>accessibility@dailynumbermatch.online</strong></li>
                </ul>
                <p>
