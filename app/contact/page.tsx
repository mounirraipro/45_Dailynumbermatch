...
const SUPPORT_EMAIL = 'hello@dailynumbermatch.online';

export const metadata: Metadata = {
    title: 'Contact Daily Number Match',
    description: 'Get in touch with the Daily Number Match team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Daily Number Match', 'Daily Number Match support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};
