...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Daily Number Match. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Daily Number Match sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Daily Number Match' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Daily Number Match?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Daily Number Match.</p>
                </div>
            </div>
